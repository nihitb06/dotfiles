...
apps.brave = function()
    helpers.run_or_raise({class = 'Brave'}, false, "brave")
end
apps.file_manager = function ()
    awful.spawn(user.file_manager, { floating = true })
end
apps.neofetch = function ()
    awful.spawn(user.terminal .. " -e zsh -c 'neofetch; zsh'", { 
        floating = true,
...
apps.github = function ()
    awful.spawn.with_shell("xdg-open https://github.com/nihitb06")
end
apps.youtube = function ()
    awful.spawn.with_shell("xdg-open https://youtube.com")
end
apps.reddit = function ()
    awful.spawn.with_shell("xdg-open https://reddit.com/r/unixporn")
end
...
apps.popcorntime = function ()
    awful.spawn("popcorntime")
end
