...
host_text.markup = helpers.colorize_text("@archie", x.color8)
...
local function create_bookmark(name, path, color, hover_color)
    ...
    bookmark:buttons(gears.table.join(
        ...
        awful.button({ }, 3, function ()
            awful.spawn.with_shell(user.terminal.." -e 'nnn' "..path)
            dashboard_hide()
        end)
    ))
    ...
    helpers.add_hover_cursor(bookmark, "hand2")
...
helpers.add_hover_cursor(corona_box, "hand2")
...
helpers.add_hover_cursor(fortune_box, "hand2")
...
local petal_top_left = create_url_petal("GH", x.color4, x.color12, "https://github.com/nihitb06", true, true, false, true)
local petal_top_right = create_url_petal("YT", x.color1, x.color9, "https://youtube.com/", true, true, true, false)
local petal_bottom_right = create_url_petal("9A", x.color2, x.color10, "https://9anime.to/",false, true, true, true)
...
helpers.add_hover_cursor(petal_top_left, "hand2")
helpers.add_hover_cursor(petal_top_right, "hand2")
helpers.add_hover_cursor(petal_bottom_left, "hand2")
helpers.add_hover_cursor(petal_bottom_right, "hand2")
...
helpers.add_hover_cursor(uptime_box, "hand2")
...
helpers.add_hover_cursor(notification_state_box, "hand2")
...
helpers.add_hover_cursor(screenshot_box, "hand2")
...
function dashboard_show()
    -- Fix cursor sometimes turning into "hand2" right after showing the dashboard
