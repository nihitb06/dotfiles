...
icons.text.by_class = {
    ...
    ['Brave'] = { symbol = "", color = x.color3 },
    ['brave-browser'] = { symbol = "", color = x.color3 },
    ['Brave-browser'] = { symbol = "", color = x.color3 },
    ['brave'] = { symbol = "", color = x.color3 },
    ['firefox'] = { symbol = "", color = x.color3 },
    ...
    ['Popcorn-Time'] = { symbol = "", color = x.color4 },
