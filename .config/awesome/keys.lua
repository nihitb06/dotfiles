...
keys.globalkeys = gears.table.join(
    ...
    awful.key({ superkey }, "d",
        function()
            awful.spawn.with_shell("sh ~/.config/rofi/launchers/launcher.sh")
        end,
    ...
    awful.key( { superkey }, "Print", function() apps.screenshot("selection") end,
    ...
    -- the browser
    awful.key({ superkey }, "i", hotkeys_popup.show_help,
