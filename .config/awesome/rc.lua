...
user = {
    ...
    dirs = {
        ...
        wallpapers = os.getenv("XDG_WALLS_DIR") or "~/Pictures/Wallpapers",
    ...
    openweathermap_key = "d670a279de0298a0cd31403bee045399",
    openweathermap_city_id = "1261481",
...
beautiful.systray_icon_spacing = dpi(9)
beautiful.border_width = 1
beautiful.border_normal = x.background
beautiful.border_focus = x.color8
...
client.connect_signal("manage", function (c)
    ...
    -- Spotify Management
    -- Spotify does not follow ICCCM guidelines and only sets its
    -- WM_CLASS attribute after the client has become visible.
    -- By this time all the generic rules have already been applied
    -- and Spotify specific rules are skipped.
    -- This will apply Spotify specific rules.
